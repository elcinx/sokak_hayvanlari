...
router.get("/gallery/list",isAuth,requireRole("admin","koordinator"),csrfProtection,adminPanel.galleryList);
...
router.post("/gallery/delete/:id",isAuth,requireRole("admin","koordinator"),csrfProtection,adminPanel.galleryDelete);
